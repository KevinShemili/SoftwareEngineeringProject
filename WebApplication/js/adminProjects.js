...
let prepareContent = (projects) => {
  ...
  if (projects) {
    for (let project of projects) {
      ...
      <td>
        <div class="dropdown">
            <a class="btn btn-sm btn-primary" href="../views/viewProjectAdmin.php?analyseId=${project.id}" self-id="${project.id}">Details</a>
                <a class="btn btn-sm btn-warning" href="../scripts/deleteProject.php?analyseId=${project.id}" self-id="${project.id}">Delete</a>
        </div>
      </td>
    </tr>`;
